...
class GraphHelper
{
  // Settings object
    ...
    // or other code
    public static Task<TodoTaskList?> MakeGraphCallAsync()
    {
        // Ensure client isn't null
    _ = _userClient ??
        throw new System.NullReferenceException("Graph has not been initialized for user auth");
    ...
    return _userClient.Me
        .Todo
        .Lists["AQMkADAwATM3ZmYAZS1kNGE4LTYyZDctMDACLTAwCgAuAAAD3Ccey9izB06k1rEzyDiaoAEAGavVsQGdB0e8LbgqNtshJwAAAgESAAAA"]
        .GetAsync();
    }
}